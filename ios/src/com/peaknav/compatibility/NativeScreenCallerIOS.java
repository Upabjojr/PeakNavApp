 ...
 * the image pickers, the GPX picker, the tutorial and the app-info page. The map itself
 * needs nothing from here: the road and path layer is rasterized in plain Java by core, the
